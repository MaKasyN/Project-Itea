        ...
        <v-card v-for="(item, i) in cards"
            ...
            <v-list-item three-line>
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle class="blue--text body-2 text--darken-4">{{item.content}}
        ...
        data() {
            return {
                cards: {
                    item1: {
                        head: "Зручність",
                        content: "Купуй в кілька кліків"
                    },
                    item2: {
                        head: "Якість",
                        content: "Товар від перевірених виробників"
                    },
                    item3: {
                        head: "Асортимент",
                        content: "Більше 50 партнерських компаній"
                    }
                }
            }
        }
