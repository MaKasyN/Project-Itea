    ...
    <div class="storeCardWrapper 
        ...
        <v-dialog v-model="dialog">
            <v-btn class="closeBtn grey--text text--lighten-1" @click="dialog = !dialog" icon>
             ...
             <v-card class="mx-auto ma-5 woodCard"
                        color="grey lighten-4"
                        width="400"
                        max-width="600">
                    <v-img :aspect-ratio="16/9"
                        :src="getProducts[index].PhotoUrl || ''">
                    </v-img>
                    <v-card-text class="pt-6"
                                style="position: relative;">
                        <v-btn @click="addToCart(getProducts[index])"
                                absolute
                                color="orange"
                                class="white--text"
                                fab
                        ...
                        <h3 class="body-1 font-weight-medium orange--text mb-2">{{getProducts[index].Name}}</h3>
